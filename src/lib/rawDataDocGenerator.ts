      ...
      const userRows = [
        new TableRow({
          ...
          children: [
            ...
            new TableCell({ 
              children: [new Paragraph({ text: 'SAM Account', bold: true })],
              shading: { fill: "3B82F6", color: "FFFFFF" },
            }),
            new TableCell({ 
            ...
            new TableCell({ 
              children: [new Paragraph({ text: 'Habilitado', bold: true })],
              shading: { fill: "3B82F6", color: "FFFFFF" },
            }),
            new TableCell({ 
              children: [new Paragraph({ text: 'Último Logon', bold: true })],
              shading: { fill: "3B82F6", color: "FFFFFF" },
            }),
          ],
        }),
      ...
      if (users.length > 200) {
        userRows.push(
          new TableRow({
            children: [
              new TableCell({ 
                children: [new Paragraph({ text: `... y ${users.length - 200} usuarios más (datos completos en JSON original)`, italics: true })],
                columnSpan: 5,
                shading: { fill: "F3F4F6" },
              }),
            ],
      ...
      const groupRows = [
        new TableRow({
          ...
          children: [
            ...
            new TableCell({ 
              children: [new Paragraph({ text: 'Categoría', bold: true })],
              shading: { fill: "10B981", color: "FFFFFF" },
            }),
            new TableCell({ 
              children: [new Paragraph({ text: 'Miembros', bold: true })],
              shading: { fill: "10B981", color: "FFFFFF" },
            }),
            new TableCell({ 
      ...
      if (groups.length > 100) {
        groupRows.push(
          new TableRow({
            children: [
              new TableCell({ 
                children: [new Paragraph({ text: `... y ${groups.length - 100} grupos más`, italics: true })],
                columnSpan: 5,
                shading: { fill: "F3F4F6" },
              }),
            ],
    ...
    if (gpos.length > 0) {
      const gpoRows = [
        new TableRow({
          ...
          children: [
            new TableCell({ 
              children: [new Paragraph({ text: 'Display Name', bold: true })],
              shading: { fill: "8B5CF6", color: "FFFFFF" },
            }),
            new TableCell({ 
              children: [new Paragraph({ text: 'GUID', bold: true })],
              shading: { fill: "8B5CF6", color: "FFFFFF" },
            }),
            new TableCell({ 
            ...
            new TableCell({ 
              children: [new Paragraph({ text: 'Creación', bold: true })],
              shading: { fill: "8B5CF6", color: "FFFFFF" },
            }),
          ],
        }),
      ...
      const computerRows = [
        new TableRow({
          ...
          children: [
            ...
            new TableCell({ 
              children: [new Paragraph({ text: 'DNS', bold: true })],
              shading: { fill: "F59E0B", color: "FFFFFF" },
            }),
            new TableCell({ 
              children: [new Paragraph({ text: 'Sistema Operativo', bold: true })],
              shading: { fill: "F59E0B", color: "FFFFFF" },
            }),
            new TableCell({ 
              children: [new Paragraph({ text: 'Habilitado', bold: true })],
      ...
      if (computers.length > 150) {
        computerRows.push(
          new TableRow({
            children: [
              new TableCell({ 
                children: [new Paragraph({ text: `... y ${computers.length - 150} computadoras más`, italics: true })],
                columnSpan: 4,
                shading: { fill: "F3F4F6" },
              }),
            ],
      ...
      const ouRows = [
        new TableRow({
          ...
          children: [
            ...
            new TableCell({ 
              children: [new Paragraph({ text: 'Distinguished Name', bold: true })],
              shading: { fill: "EF4444", color: "FFFFFF" },
            }),
          ],
        }),
